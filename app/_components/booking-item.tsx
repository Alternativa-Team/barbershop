                        ...
                        <AlertDialog>
                            <AlertDialogTrigger>
                                <Button
                                    ...
                                    className="w-full" variant={isBookingConfirmed ? "destructive" : "secondary"}>
                            ...
                            <AlertDialogContent className="w-[90%]">
                                ...
                                <AlertDialogFooter className="flex-row gap-3">
                                    <AlertDialogAction className="w-full" onClick={handleCancelClick}> {isDeleteLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />} Confirmar</AlertDialogAction>
                                    <AlertDialogCancel className="w-full mt-0" disabled={isDeleteLoading} >Voltar</AlertDialogCancel>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
                        <SheetClose asChild>
